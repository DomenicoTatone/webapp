(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function t(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(a){if(a.ep)return;a.ep=!0;const s=t(a);fetch(a.href,s)}})();class y{constructor(e,t={}){this.originalSelect=e,this.options={searchable:t.searchable||!1,placeholder:t.placeholder||"Select...",...t},this.isOpen=!1,this.selectedIndex=-1,this.focusedIndex=-1,this.id=`custom-select-${Math.random().toString(36).substr(2,9)}`,this.init()}init(){this.originalSelect.style.display="none",this.originalSelect.setAttribute("aria-hidden","true"),this.container=this.createContainer(),this.originalSelect.parentNode.insertBefore(this.container,this.originalSelect.nextSibling),this.syncFromOriginal(),this.bindEvents()}createContainer(){const e=document.createElement("div");return e.className="custom-select",e.innerHTML=`
    ...
    `}initGetYourGuidePage(){const e={it:"https://www.getyourguide.it/?partner_id=Q5TFESQ&utm_medium=online_publisher",es:"https://www.getyourguide.es/?partner_id=Q5TFESQ&utm_medium=online_publisher",en:"https://www.getyourguide.com/?partner_id=Q5TFESQ&utm_medium=online_publisher",fr:"https://www.getyourguide.fr/?partner_id=Q5TFESQ&utm_medium=online_publisher"},t=document.getElementById("gygLangSelect"),n=document.getElementById("gygHomepageLink");t&&new y(t);const a=()=>{const o=e[t.value]||e.en;n.href=o,n.textContent=o};t.addEventListener("change",a),a(),document.getElementById("gygHomepageCopyBtn")?.addEventListener("click",async()=>{const o=await m.copyToClipboard(n.href);p[o?"success":"error"](c.t(o?"deepLinkCopied":"copyError"))}),document.getElementById("gygHomepageOpenBtn")?.addEventListener("click",()=>{m.openLink(n.href)});const s=document.getElementById("gygInput"),i=document.getElementById("gygGenerateBtn"),l=document.getElementById("gygResult"),d=document.getElementById("gygResultLink");i.addEventListener("click",()=>{const o=s.value.trim();if(!o){p.warning(c.t("validGetYourGuideURL"));return}const u=m.generateGetYourGuideLink(o);u.success?(d.href=u.link,d.textContent=u.link,l.style.display="block",p.success(c.t("deepLinkGenerated"))):p.error(c.t(u.error))}),document.getElementById("gygCopyBtn")?.addEventListener("click",async()=>{const o=await m.copyToClipboard(d.href);p[o?"success":"error"](c.t(o?"deepLinkCopied":"copyError"))}),document.getElementById("gygOpenBtn")?.addEventListener("click",()=>{m.openLink(d.href)})}renderCivitatisPage(){return`
      <div class="page-header">
    ...
    `}initCivitatisPage(){const e={it:"https://www.civitatis.com/it/?aid=5488",es:"https://www.civitatis.com/es/?aid=5488",en:"https://www.civitatis.com/en/?aid=5488",fr:"https://www.civitatis.com/fr/?aid=5488"},t=document.getElementById("civLangSelect"),n=document.getElementById("civHomepageLink");t&&new y(t);const a=()=>{const o=e[t.value]||e.en;n.href=o,n.textContent=o};t.addEventListener("change",a),a(),document.getElementById("civHomepageCopyBtn")?.addEventListener("click",async()=>{const o=await m.copyToClipboard(n.href);p[o?"success":"error"](c.t(o?"deepLinkCopied":"copyError"))}),document.getElementById("civHomepageOpenBtn")?.addEventListener("click",()=>{m.openLink(n.href)});const s=document.getElementById("civInput"),i=document.getElementById("civGenerateBtn"),l=document.getElementById("civResult"),d=document.getElementById("civResultLink");i.addEventListener("click",()=>{const o=s.value.trim();if(!o){p.warning(c.t("validCivitatisURL"));return}const u=m.generateCivitatisLink(o);u.success?(d.href=u.link,d.textContent=u.link,l.style.display="block",p.success(c.t("deepLinkGenerated"))):p.error(c.t(u.error))}),document.getElementById("civCopyBtn")?.addEventListener("click",async()=>{const o=await m.copyToClipboard(d.href);p[o?"success":"error"](c.t(o?"deepLinkCopied":"copyError"))}),document.getElementById("civOpenBtn")?.addEventListener("click",()=>{m.openLink(d.href)})}renderCarRentalPage(){return`
      <div class="page-header">
    ...
    `}initCarRentalPage(){const e=document.getElementById("carProviderSelect"),t=document.getElementById("carLangSelect"),n=document.getElementById("carResultLink");e&&new y(e),t&&new y(t);const a=()=>{const s=I[e.value],i=t.value,l=s.urls[i]||s.urls.en||Object.values(s.urls)[0];n.href=l,n.textContent=l};e.addEventListener("change",a),t.addEventListener("change",a),a(),document.getElementById("carCopyBtn")?.addEventListener("click",async()=>{const s=await m.copyToClipboard(n.href);p[s?"success":"error"](c.t(s?"deepLinkCopied":"copyError"))}),document.getElementById("carOpenBtn")?.addEventListener("click",()=>{m.openLink(n.href)})}renderImageToolPage(){return`
      <div class="page-header">
    ...
    `}initImageToolPage(){const e=document.getElementById("dropZone"),t=document.getElementById("imageInput"),n=document.getElementById("qualitySlider"),a=document.getElementById("qualityValue"),s=document.getElementById("formatSelect"),i=document.getElementById("imagesContainer"),l=document.getElementById("downloadAllContainer");s&&new y(s),this.compressedImages=[],n.addEventListener("input",()=>{a.textContent=`${n.value}%`}),e.addEventListener("click",()=>t.click()),["dragenter","dragover","dragleave","drop"].forEach(d=>{e.addEventListener(d,o=>{o.preventDefault(),o.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",d=>{e.classList.remove("drag-over");const o=d.dataTransfer.files;this.processImages(o)}),t.addEventListener("change",()=>{this.processImages(t.files)}),document.getElementById("clearAllBtn")?.addEventListener("click",()=>{this.compressedImages=[],i.innerHTML="",l.style.display="none"}),document.getElementById("downloadAllBtn")?.addEventListener("click",async()=>{this.compressedImages.length!==0&&await this.downloadAllAsZip()})}async processImages(e){const t=document.getElementById("qualitySlider").value/100,n=document.getElementById("formatSelect").value,a=document.getElementById("imagesContainer"),s=document.getElementById("downloadAllContainer");for(const i of e)if(i.type.startsWith("image/"))try{const l=await this.compressImage(i,t,n);this.compressedImages.push(l),this.renderImageCard(l,a),this.updateTotalStats(),s.style.display="block"}catch(l){console.error("Compression error:",l),p.error(`Errore: ${i.name}`)}}compressImage(e,t,n){return new Promise((a,s)=>{const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{const o=document.createElement("canvas");o.width=d.naturalWidth,o.height=d.naturalHeight,o.getContext("2d").drawImage(d,0,0),o.toBlob(g=>{if(!g){s(new Error("Compression failed"));return}const h=n==="image/webp"?"webp":n==="image/png"?"png":"jpg",b=e.name.replace(/\.[^/.]+$/,"");a({originalName:e.name,compressedName:`${b}_compressed.${h}`,originalSize:e.size,compressedSize:g.size,reduction:((1-g.size/e.size)*100).toFixed(1),blob:g,url:URL.createObjectURL(g)})},n,t)},d.onerror=s,d.src=l.target.result},i.onerror=s,i.readAsDataURL(e)})}renderImageCard(e,t){const n=document.createElement("div");n.className="image-card";const a=i=>i>1024*1024?`${(i/1024/1024).toFixed(2)} MB`:`${(i/1024).toFixed(1)} KB`,s=parseFloat(e.reduction)>50?"text-success":parseFloat(e.reduction)>20?"text-warning":"text-muted";n.innerHTML=`
