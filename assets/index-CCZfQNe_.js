(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function t(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(n){if(n.ep)return;n.ep=!0;const s=t(n);fetch(n.href,s)}})();const k=["it","en","es","fr","de"],b="it";class E{constructor(){this.messages={},this.currentLanguage=b,this.isLoaded=!1}async init(){return this.currentLanguage=this.detectBrowserLanguage(),await this.loadMessages(this.currentLanguage),this.applyLanguageToDocument(),this}detectBrowserLanguage(){const e=localStorage.getItem("selectedLanguage");if(e&&k.includes(e))return e;const t=navigator.languages||[navigator.language||navigator.userLanguage];for(const a of t){const n=a.split("-")[0].toLowerCase();if(k.includes(n))return console.log(`[i18n] Browser language detected: ${n}`),n}return console.log(`[i18n] No matching language found, using default: ${b}`),b}async loadMessages(e){try{const t=await fetch(`/_locales/${e}/messages.json`);if(!t.ok)throw new Error(`Failed to load ${e} messages`);this.messages=await t.json(),this.isLoaded=!0,console.log(`[i18n] Loaded messages for: ${e}`)}catch(t){console.error(`[i18n] Error loading ${e}:`,t),e!==b&&(console.log(`[i18n] Falling back to ${b}`),await this.loadMessages(b))}}getLanguage(){return this.currentLanguage}async setLanguage(e){return k.includes(e)?(this.currentLanguage=e,localStorage.setItem("selectedLanguage",e),await this.loadMessages(e),this.applyLanguageToDocument(),this.translatePage(),!0):(console.warn(`[i18n] Language ${e} not supported`),!1)}applyLanguageToDocument(){document.documentElement.lang=this.currentLanguage}t(e){return this.isLoaded?this.messages[e]||e:(console.warn("[i18n] Messages not loaded yet"),e)}translatePage(){this.isLoaded&&(document.querySelectorAll("[data-i18n]").forEach(e=>{const t=e.getAttribute("data-i18n"),a=this.t(t);e.tagName==="INPUT"||e.tagName==="TEXTAREA"||(e.textContent=a)}),document.querySelectorAll("[data-i18n-placeholder]").forEach(e=>{const t=e.getAttribute("data-i18n-placeholder");e.placeholder=this.t(t)}),document.querySelectorAll("[data-i18n-title]").forEach(e=>{const t=e.getAttribute("data-i18n-title");e.title=this.t(t)}))}getSupportedLanguages(){return[{code:"it",label:"Italiano",flag:"🇮🇹"},{code:"en",label:"English",flag:"🇬🇧"},{code:"es",label:"Español",flag:"🇪🇸"},{code:"fr",label:"Français",flag:"🇫🇷"},{code:"de",label:"Deutsch",flag:"🇩🇪"}]}}const c=new E,f={1639250:"Isola di Minorca IT",3220593:"Isola di Formentera",3337668:"Isola di Lanzarote",3349565:"Isola di Minorca EN",3349567:"Isola di Minorca ES",3335968:"Vacanze nel Mediterraneo"},C={1639250:["Allianz Global Assistance","AXA Assistance","Barceló Hotels & Resorts","BeGood - Trattamento di Bellezza da Indossare","Columbus Assicurazioni","Direct Ferries IT","eDreams","Grandi Navi Veloci IT","HUMANTE Amore gel lubrificante","ORBIS Lifestyle","Viaggi in crociera","Viaggisicuri","Vueling IT","Weweed","Yalla Yalla"],3220593:["À La Folie","eDreams","Vueling IT","Weweed"],3337668:["Direct Ferries IT","eDreams","Vueling IT","Weweed"],3349565:["30% PLUS Commissions Performance Web Hosting","Airport Parking Luton","Compare Cheap Airport Parking Prices","Compare Parking Prices","Direct Ferries UK","Muslim Aid","One 2 One Flights UK","Vueling UK"],3349567:["My Tea Moments - Té e Infusiones Online"]},L={1639250:{"Allianz Global Assistance":"https://clk.tradedoubler.com/click?p=72847&a=1639250","AXA Assistance":"https://clk.tradedoubler.com/click?p=261028&a=1639250","Barceló Hotels & Resorts":"https://clk.tradedoubler.com/click?p=277498&a=1639250","BeGood - Trattamento di Bellezza da Indossare":"https://clk.tradedoubler.com/click?p=346681&a=1639250","Columbus Assicurazioni":"https://clk.tradedoubler.com/click?p=270116&a=1639250","Direct Ferries IT":"https://clk.tradedoubler.com/click?p=275606&a=1639250",eDreams:"https://clk.tradedoubler.com/click?p=17269&a=1639250","Grandi Navi Veloci IT":"https://clk.tradedoubler.com/click?p=255412&a=1639250","HUMANTE Amore gel lubrificante":"https://clk.tradedoubler.com/click?p=352803&a=1639250","ORBIS Lifestyle":"https://clk.tradedoubler.com/click?p=351047&a=1639250","Viaggi in crociera":"https://clk.tradedoubler.com/click?p=282015&a=1639250",Viaggisicuri:"https://clk.tradedoubler.com/click?p=309891&a=1639250","Vueling IT":"https://clk.tradedoubler.com/click?p=288053&a=1639250",Weweed:"https://clk.tradedoubler.com/click?p=343473&a=1639250","Yalla Yalla":"https://clk.tradedoubler.com/click?p=218733&a=1639250"},3220593:{"À La Folie":"https://clk.tradedoubler.com/click?p=348934&a=3220593",eDreams:"https://clk.tradedoubler.com/click?p=17269&a=3220593","Vueling IT":"https://clk.tradedoubler.com/click?p=288053&a=3220593",Weweed:"https://clk.tradedoubler.com/click?p=343473&a=3220593"},3337668:{"Direct Ferries IT":"https://clk.tradedoubler.com/click?p=275606&a=3337668",eDreams:"https://clk.tradedoubler.com/click?p=17269&a=3337668","Vueling IT":"https://clk.tradedoubler.com/click?p=288053&a=3337668",Weweed:"https://clk.tradedoubler.com/click?p=343473&a=3337668"},3349565:{"30% PLUS Commissions Performance Web Hosting":"https://clk.tradedoubler.com/click?p=355894&a=3349565","Airport Parking Luton":"https://clk.tradedoubler.com/click?p=343105&a=3349565","Compare Cheap Airport Parking Prices":"https://clk.tradedoubler.com/click?p=340817&a=3349565","Compare Parking Prices":"https://clk.tradedoubler.com/click?p=338693&a=3349565","Direct Ferries UK":"https://clk.tradedoubler.com/click?p=275605&a=3349565","Muslim Aid":"https://clk.tradedoubler.com/click?p=287611&a=3349565","One 2 One Flights UK":"https://clk.tradedoubler.com/click?p=339657&a=3349565","Vueling UK":"https://clk.tradedoubler.com/click?p=320047&a=3349565"},3349567:{"My Tea Moments - Té e Infusiones Online":"https://clk.tradedoubler.com/click?p=357725&a=3349567"}},w=[{name:"Coches Menorca",urls:{it:"https://cochesmenorca.es/it/?agentId=3",es:"https://cochesmenorca.es/?agentId=3",en:"https://cochesmenorca.es/en/?agentId=3",fr:"https://cochesmenorca.es/en/?agentId=3",de:"https://cochesmenorca.es/en/?agentId=3"}},{name:"Menorca Rent",urls:{it:"https://www.menorcarent.com/it/?agentId=15",es:"https://www.menorcarent.com/?agentId=15",en:"https://www.menorcarent.com/en/?agentId=15",fr:"https://www.menorcarent.com/fr/?agentId=15",de:"https://www.menorcarent.com/en/?agentId=15"}},{name:"Autos Xoroi",urls:{it:"http://www.alquilercochesmenorca.com/it/?link=ISOLADIMINORCA",es:"http://www.alquilercochesmenorca.com/es/?link=ISOLADIMINORCA",en:"http://www.alquilercochesmenorca.com/?link=ISOLADIMINORCA",fr:"http://www.alquilercochesmenorca.com/fr/?link=ISOLADIMINORCA",de:"http://www.alquilercochesmenorca.com/?link=ISOLADIMINORCA"}},{name:"HIPER Rent a Car",urls:{it:"https://hiperrentacar.com/it/?colaborador=LO-0495108",es:"https://hiperrentacar.com/es/?colaborador=LO-0495108",en:"https://hiperrentacar.com/en/?colaborador=LO-0495108",fr:"https://hiperrentacar.com/fr/?colaborador=LO-0495108",de:"https://hiperrentacar.com/de/?colaborador=LO-0495108"}},{name:"Rentalcars",urls:{it:"https://www.rentalcars.com/it/?affiliateCode=latitudine983",es:"https://www.rentalcars.com/es/?affiliateCode=latitudine983",en:"https://www.rentalcars.com/en/?affiliateCode=latitudine983",fr:"https://www.rentalcars.com/fr/?affiliateCode=latitudine983",de:"https://www.rentalcars.com/de/?affiliateCode=latitudine983"}}],B={1639250:{"Allianz Global Assistance":["https://www.allianz-assistance.it/"],"AXA Assistance":["https://www.assicurazione-viaggio.axa-assistance.it/"],"Barceló Hotels & Resorts":["https://www.barcelo.com/"],"Columbus Assicurazioni":["https://www.columbusassicurazioni.it/"],"Direct Ferries IT":["https://www.directferries"],eDreams:["https://www.edreams.it/","https://rentacar.edreams.it/","https://navette.edreams.it","https://hotels.edreams.it/"],"Grandi Navi Veloci IT":["https://www.gnv.it/"],Viaggisicuri:["https://www.viaggisicuri.com/"],"Vueling IT":["https://www.vueling.com/","https://cars.vueling.com","https://hotel.vueling.com/","https://activities.vueling.com/","https://parking.vueling.com/"],Weweed:["https://prodotti-cannabis.it/"],"Yalla Yalla":["https://www.yallayalla.it/"]},3220593:{"À La Folie":["https://alafolie.it/"],eDreams:["https://www.edreams.it/","https://rentacar.edreams.it/"],"Vueling IT":["https://www.vueling.com/"],Weweed:["https://prodotti-cannabis.it/"]},3337668:{"Direct Ferries IT":["https://www.directferries"],eDreams:["https://www.edreams.it/"],"Vueling IT":["https://www.vueling.com/"],Weweed:["https://prodotti-cannabis.it/"]},3349565:{"Vueling UK":["https://www.vueling.com/"]},3349567:{"My Tea Moments - Té e Infusiones Online":["https://myteamoments.com/"]}};class P{generateDeepLink(e,t,a){let n;try{n=new URL(e)}catch{return{success:!1,error:"invalidUrl"}}const s=this.getPartnerBaseLink(t,a);if(!s)return{success:!1,error:"Programma o partner non trovato"};if(!this.validateUrl(n.href,t,a))return{success:!1,error:`URL non valido per ${a}`};const i=encodeURIComponent(n.href);return{success:!0,link:`${s}&url=${i}`}}getPartnerBaseLink(e,t){return L[e]?.[t]||null}validateUrl(e,t,a){const n=B[t]?.[a];return n?n.some(s=>e.includes(s)):!0}getPartnersForIsland(e){const t=L[e];return t?Object.keys(t).map(a=>({name:a,link:t[a]})):[]}getIslandName(e){return f[e]||"Isola Sconosciuta"}getAllIslands(){return Object.entries(f).map(([e,t])=>({code:e,name:t,displayName:`${t} - ${e}`}))}async copyToClipboard(e){try{return await navigator.clipboard.writeText(e),!0}catch{try{const a=document.createElement("textarea");return a.value=e,a.style.position="fixed",a.style.left="-9999px",document.body.appendChild(a),a.select(),document.execCommand("copy"),document.body.removeChild(a),!0}catch{return!1}}}openLink(e){window.open(e,"_blank","noopener,noreferrer")}generateGetYourGuideLink(e){try{return new URL(e).hostname.match(/getyourguide\.[a-z]{2,}/i)?{success:!0,link:`https://www.getyourguide.com/click/track?partner_id=32A3BBP4J4PPZMHRC1G0&url=${encodeURIComponent(e)}`}:{success:!1,error:"validGetYourGuideURL"}}catch{return{success:!1,error:"invalidUrl"}}}generateCivitatisLink(e){try{return new URL(e).hostname.match(/civitatis\.[a-z]{2,}/i)?{success:!0,link:`https://www.civitatis.com/affiliate/?aid=52698&url=${encodeURIComponent(e)}`}:{success:!1,error:"validCivitatisURL"}}catch{return{success:!1,error:"invalidUrl"}}}}const m=new P;class S{constructor(){this.container=null}init(){if(!this.container&&(this.container=document.createElement("div"),this.container.id="notification-container",this.container.style.cssText=`
    ...
    `).join(""),e.querySelectorAll("[data-copy]").forEach(a=>{a.addEventListener("click",async()=>{const n=await m.copyToClipboard(a.dataset.copy);g[n?"success":"error"](c.t(n?"deepLinkCopied":"copyError"))})})}renderTradedoublerPage(){return`
      <div class="page-header">
    ...
    `}initTradedoublerPage(){const e=document.getElementById("islandSelect"),t=document.getElementById("platformSelect"),a=document.getElementById("partnerLinkContainer"),n=document.getElementById("partnerLink"),s=document.getElementById("generateBtn"),i=document.getElementById("inputUrl"),l=document.getElementById("resultContainer"),d=document.getElementById("resultLink");e.addEventListener("change",()=>{const o=e.value;t.innerHTML=`<option value="">${c.t("selectPlatform")}</option>`,o?((C[o]||[]).forEach(u=>{t.appendChild(new Option(u,u))}),t.disabled=!1):t.disabled=!0,a.style.display="none",l.style.display="none"}),t.addEventListener("change",()=>{const o=e.value,u=t.value;if(o&&u){const p=m.getPartnerBaseLink(o,u);p&&(n.innerHTML=`<a href="${p}" target="_blank">${p}</a>`,a.style.display="block")}else a.style.display="none"}),s.addEventListener("click",()=>{const o=e.value,u=t.value,p=i.value.trim();if(!o||!u){g.warning(c.t("selectSiteAndPlatform"));return}if(!p){g.warning(c.t("enterUrl"));return}const h=m.generateDeepLink(p,o,u);h.success?(d.href=h.link,d.textContent=h.link,l.style.display="block",g.success(c.t("deepLinkGenerated"))):g.error(c.t(h.error)||h.error)}),document.getElementById("copyResultBtn")?.addEventListener("click",async()=>{const o=await m.copyToClipboard(d.href);g[o?"success":"error"](c.t(o?"deepLinkCopied":"copyError"))}),document.getElementById("openResultBtn")?.addEventListener("click",()=>{m.openLink(d.href)})}renderGetYourGuidePage(){return`
      <div class="page-header">
    ...
    `}initGetYourGuidePage(){const e={it:"https://www.getyourguide.it/?partner_id=Q5TFESQ&utm_medium=online_publisher",es:"https://www.getyourguide.es/?partner_id=Q5TFESQ&utm_medium=online_publisher",en:"https://www.getyourguide.com/?partner_id=Q5TFESQ&utm_medium=online_publisher",fr:"https://www.getyourguide.fr/?partner_id=Q5TFESQ&utm_medium=online_publisher"},t=document.getElementById("gygLangSelect"),a=document.getElementById("gygHomepageLink"),n=()=>{const o=e[t.value]||e.en;a.href=o,a.textContent=o};t.addEventListener("change",n),n(),document.getElementById("gygHomepageCopyBtn")?.addEventListener("click",async()=>{const o=await m.copyToClipboard(a.href);g[o?"success":"error"](c.t(o?"deepLinkCopied":"copyError"))}),document.getElementById("gygHomepageOpenBtn")?.addEventListener("click",()=>{m.openLink(a.href)});const s=document.getElementById("gygInput"),i=document.getElementById("gygGenerateBtn"),l=document.getElementById("gygResult"),d=document.getElementById("gygResultLink");i.addEventListener("click",()=>{const o=s.value.trim();if(!o){g.warning(c.t("validGetYourGuideURL"));return}const u=m.generateGetYourGuideLink(o);u.success?(d.href=u.link,d.textContent=u.link,l.style.display="block",g.success(c.t("deepLinkGenerated"))):g.error(c.t(u.error))}),document.getElementById("gygCopyBtn")?.addEventListener("click",async()=>{const o=await m.copyToClipboard(d.href);g[o?"success":"error"](c.t(o?"deepLinkCopied":"copyError"))}),document.getElementById("gygOpenBtn")?.addEventListener("click",()=>{m.openLink(d.href)})}renderCivitatisPage(){return`
      <div class="page-header">
    ...
    `}initCivitatisPage(){const e={it:"https://www.civitatis.com/it/?aid=5488",es:"https://www.civitatis.com/es/?aid=5488",en:"https://www.civitatis.com/en/?aid=5488",fr:"https://www.civitatis.com/fr/?aid=5488"},t=document.getElementById("civLangSelect"),a=document.getElementById("civHomepageLink"),n=()=>{const o=e[t.value]||e.en;a.href=o,a.textContent=o};t.addEventListener("change",n),n(),document.getElementById("civHomepageCopyBtn")?.addEventListener("click",async()=>{const o=await m.copyToClipboard(a.href);g[o?"success":"error"](c.t(o?"deepLinkCopied":"copyError"))}),document.getElementById("civHomepageOpenBtn")?.addEventListener("click",()=>{m.openLink(a.href)});const s=document.getElementById("civInput"),i=document.getElementById("civGenerateBtn"),l=document.getElementById("civResult"),d=document.getElementById("civResultLink");i.addEventListener("click",()=>{const o=s.value.trim();if(!o){g.warning(c.t("validCivitatisURL"));return}const u=m.generateCivitatisLink(o);u.success?(d.href=u.link,d.textContent=u.link,l.style.display="block",g.success(c.t("deepLinkGenerated"))):g.error(c.t(u.error))}),document.getElementById("civCopyBtn")?.addEventListener("click",async()=>{const o=await m.copyToClipboard(d.href);g[o?"success":"error"](c.t(o?"deepLinkCopied":"copyError"))}),document.getElementById("civOpenBtn")?.addEventListener("click",()=>{m.openLink(d.href)})}renderCarRentalPage(){return`
      <div class="page-header">
        ...
        <div class="form-row">
          <div class="form-group flex-2">
            ...
            <select id="carProviderSelect" class="form-select">
              ${w.map((e,t)=>`<option value="${t}">${e.name}</option>`).join("")}
            </select>
          </div>
          <div class="form-group flex-1">
            <label class="form-label" data-i18n="linkLanguage">Lingua Link</label>
    ...
    `}initCarRentalPage(){const e=document.getElementById("carProviderSelect"),t=document.getElementById("carLangSelect"),a=document.getElementById("carResultLink"),n=()=>{const s=w[e.value],i=t.value,l=s.urls[i]||s.urls.en||Object.values(s.urls)[0];a.href=l,a.textContent=l};e.addEventListener("change",n),t.addEventListener("change",n),n(),document.getElementById("carCopyBtn")?.addEventListener("click",async()=>{const s=await m.copyToClipboard(a.href);g[s?"success":"error"](c.t(s?"deepLinkCopied":"copyError"))}),document.getElementById("carOpenBtn")?.addEventListener("click",()=>{m.openLink(a.href)})}renderImageToolPage(){return`
      <div class="page-header">
    ...
    `}initImageToolPage(){const e=document.getElementById("dropZone"),t=document.getElementById("imageInput"),a=document.getElementById("qualitySlider"),n=document.getElementById("qualityValue");document.getElementById("formatSelect");const s=document.getElementById("imagesContainer"),i=document.getElementById("downloadAllContainer");this.compressedImages=[],a.addEventListener("input",()=>{n.textContent=`${a.value}%`}),e.addEventListener("click",()=>t.click()),["dragenter","dragover","dragleave","drop"].forEach(l=>{e.addEventListener(l,d=>{d.preventDefault(),d.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",l=>{e.classList.remove("drag-over");const d=l.dataTransfer.files;this.processImages(d)}),t.addEventListener("change",()=>{this.processImages(t.files)}),document.getElementById("clearAllBtn")?.addEventListener("click",()=>{this.compressedImages=[],s.innerHTML="",i.style.display="none"}),document.getElementById("downloadAllBtn")?.addEventListener("click",async()=>{this.compressedImages.length!==0&&await this.downloadAllAsZip()})}async processImages(e){const t=document.getElementById("qualitySlider").value/100,a=document.getElementById("formatSelect").value,n=document.getElementById("imagesContainer"),s=document.getElementById("downloadAllContainer");for(const i of e)if(i.type.startsWith("image/"))try{const l=await this.compressImage(i,t,a);this.compressedImages.push(l),this.renderImageCard(l,n),this.updateTotalStats(),s.style.display="block"}catch(l){console.error("Compression error:",l),g.error(`Errore: ${i.name}`)}}compressImage(e,t,a){return new Promise((n,s)=>{const i=new FileReader;i.onload=l=>{const d=new Image;d.onload=()=>{const o=document.createElement("canvas");o.width=d.naturalWidth,o.height=d.naturalHeight,o.getContext("2d").drawImage(d,0,0),o.toBlob(p=>{if(!p){s(new Error("Compression failed"));return}const h=a==="image/webp"?"webp":a==="image/png"?"png":"jpg",y=e.name.replace(/\.[^/.]+$/,"");n({originalName:e.name,compressedName:`${y}_compressed.${h}`,originalSize:e.size,compressedSize:p.size,reduction:((1-p.size/e.size)*100).toFixed(1),blob:p,url:URL.createObjectURL(p)})},a,t)},d.onerror=s,d.src=l.target.result},i.onerror=s,i.readAsDataURL(e)})}renderImageCard(e,t){const a=document.createElement("div");a.className="image-card";const n=i=>i>1024*1024?`${(i/1024/1024).toFixed(2)} MB`:`${(i/1024).toFixed(1)} KB`,s=parseFloat(e.reduction)>50?"text-success":parseFloat(e.reduction)>20?"text-warning":"text-muted";a.innerHTML=`
    ...
    `}initFeedbackPage(){const e=document.getElementById("feedbackForm"),t=document.getElementById("feedbackSuccess");e?.addEventListener("submit",async a=>{a.preventDefault();const n=document.getElementById("feedbackName").value,s=document.getElementById("feedbackEmail").value,i=document.getElementById("feedbackPlatform").value,l=document.getElementById("feedbackMessage").value,d=encodeURIComponent(`[DeepLink Pro] Feedback - ${i}`),o=encodeURIComponent(`Nome: ${n}
Email: ${s}
Piattaforma: ${i}

Messaggio:
${l}`);window.location.href=`mailto:domenico.tatone@gmail.com?subject=${d}&body=${o}`,e.style.display="none",t.style.display="block",g.success(c.t("messageSent"))}),document.getElementById("newFeedbackBtn")?.addEventListener("click",()=>{e.reset(),e.style.display="block",t.style.display="none"})}}document.addEventListener("DOMContentLoaded",()=>{new A().init()});
