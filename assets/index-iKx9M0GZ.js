(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();class f{constructor(e,t={}){this.originalSelect=e,this.options={searchable:t.searchable||!1,placeholder:t.placeholder||"Select...",...t},this.isOpen=!1,this.selectedIndex=-1,this.focusedIndex=-1,this.id=`custom-select-${Math.random().toString(36).substr(2,9)}`,this.init()}init(){this.originalSelect.style.display="none",this.originalSelect.setAttribute("aria-hidden","true"),this.container=this.createContainer(),this.originalSelect.parentNode.insertBefore(this.container,this.originalSelect.nextSibling),this.syncFromOriginal(),this.bindEvents()}createContainer(){const e=document.createElement("div");return e.className="custom-select",e.innerHTML=`
    ...
    `}initTradedoublerPage(){const e=document.getElementById("islandSelect"),t=document.getElementById("platformSelect"),a=document.getElementById("partnerLinkContainer"),n=document.getElementById("partnerLink"),i=document.getElementById("generateBtn"),s=document.getElementById("inputUrl"),l=document.getElementById("resultContainer"),d=document.getElementById("resultLink");e&&new f(e);let o=t?new f(t):null;e.addEventListener("change",()=>{const u=e.value;t.innerHTML=`<option value="">${c.t("selectPlatform")}</option>`,u?((B[u]||[]).forEach(g=>{t.appendChild(new Option(g,g))}),t.disabled=!1):t.disabled=!0,o&&o.destroy(),o=new f(t),a.style.display="none",l.style.display="none"}),t.addEventListener("change",()=>{const u=e.value,g=t.value;if(u&&g){const h=m.getPartnerBaseLink(u,g);h&&(n.innerHTML=`<a href="${h}" target="_blank">${h}</a>`,a.style.display="block")}else a.style.display="none"}),i.addEventListener("click",()=>{const u=e.value,g=t.value,h=s.value.trim();if(!u||!g){p.warning(c.t("selectSiteAndPlatform"));return}if(!h){p.warning(c.t("enterUrl"));return}const b=m.generateDeepLink(h,u,g);b.success?(d.href=b.link,d.textContent=b.link,l.style.display="block",p.success(c.t("deepLinkGenerated"))):p.error(c.t(b.error)||b.error)}),document.getElementById("copyResultBtn")?.addEventListener("click",async()=>{const u=await m.copyToClipboard(d.href);p[u?"success":"error"](c.t(u?"deepLinkCopied":"copyError"))}),document.getElementById("openResultBtn")?.addEventListener("click",()=>{m.openLink(d.href)})}renderGetYourGuidePage(){return`
      <div class="page-header">
    ...
    `}initCarRentalPage(){const e=document.getElementById("carProviderSelect"),t=document.getElementById("carLangSelect"),a=document.getElementById("carResultLink");e&&new f(e),t&&new f(t);const n=()=>{const i=I[e.value],s=t.value,l=i.urls[s]||i.urls.en||Object.values(i.urls)[0];a.href=l,a.textContent=l};e.addEventListener("change",n),t.addEventListener("change",n),n(),document.getElementById("carCopyBtn")?.addEventListener("click",async()=>{const i=await m.copyToClipboard(a.href);p[i?"success":"error"](c.t(i?"deepLinkCopied":"copyError"))}),document.getElementById("carOpenBtn")?.addEventListener("click",()=>{m.openLink(a.href)})}renderImageToolPage(){return`
      <div class="page-header">
