(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function t(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(n){if(n.ep)return;n.ep=!0;const s=t(n);fetch(n.href,s)}})();class b{constructor(e,t={}){this.originalSelect=e,this.options={searchable:t.searchable||!1,placeholder:t.placeholder||"Select...",...t},this.isOpen=!1,this.selectedIndex=-1,this.focusedIndex=-1,this.id=`custom-select-${Math.random().toString(36).substr(2,9)}`,this.init()}init(){this.originalSelect.style.display="none",this.originalSelect.setAttribute("aria-hidden","true"),this.container=this.createContainer(),this.originalSelect.parentNode.insertBefore(this.container,this.originalSelect.nextSibling),this.syncFromOriginal(),this.bindEvents()}createContainer(){const e=document.createElement("div");return e.className="custom-select",e.innerHTML=`
    ...
    `}initTradedoublerPage(){const e=document.getElementById("islandSelect"),t=document.getElementById("platformSelect"),a=document.getElementById("partnerLinkContainer"),n=document.getElementById("partnerLink"),s=document.getElementById("generateBtn"),i=document.getElementById("inputUrl"),o=document.getElementById("resultContainer"),d=document.getElementById("resultLink"),r=document.getElementById("programCardsContainer");e&&new b(e);let m=t?new b(t):null;const v=u=>{const h=C[u]||[];if(!u||h.length===0){r.innerHTML=`
          <div class="program-cards-empty">
            <span class="empty-icon">📋</span>
            <p data-i18n="selectSiteToViewPrograms">Seleziona un sito per vedere i programmi attivi</p>
          </div>
        `;return}const f=h.map(y=>{const k=g.getPartnerBaseLink(u,y);return`
      ...
      `,r.querySelectorAll("[data-copy]").forEach(y=>{y.addEventListener("click",async()=>{const k=y.dataset.copy;if(k){const E=await g.copyToClipboard(k);p[E?"success":"error"](c.t(E?"deepLinkCopied":"copyError"))}})})};e.addEventListener("change",()=>{const u=e.value;v(u),t.innerHTML=`<option value="">${c.t("selectPlatform")}</option>`,u?((C[u]||[]).forEach(h=>{t.appendChild(new Option(h,h))}),t.disabled=!1):t.disabled=!0,m&&m.destroy(),m=new b(t),a.style.display="none",o.style.display="none"}),t.addEventListener("change",()=>{const u=e.value,h=t.value;if(u&&h){const f=g.getPartnerBaseLink(u,h);f&&(n.innerHTML=`<a href="${f}" target="_blank">${f}</a>`,a.style.display="block")}else a.style.display="none"}),s.addEventListener("click",()=>{const u=e.value,h=t.value,f=i.value.trim();if(!u||!h){p.warning(c.t("selectSiteAndPlatform"));return}if(!f){p.warning(c.t("enterUrl"));return}const y=g.generateDeepLink(f,u,h);y.success?(d.href=y.link,d.textContent=y.link,o.style.display="block",p.success(c.t("deepLinkGenerated"))):p.error(c.t(y.error)||y.error)}),document.getElementById("copyResultBtn")?.addEventListener("click",async()=>{const u=await g.copyToClipboard(d.href);p[u?"success":"error"](c.t(u?"deepLinkCopied":"copyError"))}),document.getElementById("openResultBtn")?.addEventListener("click",()=>{g.openLink(d.href)})}renderGetYourGuidePage(){return`
      <div class="page-header">
    ...
    `}initGetYourGuidePage(){const e={it:"https://www.getyourguide.it/?partner_id=Q5TFESQ&utm_medium=online_publisher",es:"https://www.getyourguide.es/?partner_id=Q5TFESQ&utm_medium=online_publisher",en:"https://www.getyourguide.com/?partner_id=Q5TFESQ&utm_medium=online_publisher",fr:"https://www.getyourguide.fr/?partner_id=Q5TFESQ&utm_medium=online_publisher"},t=document.getElementById("gygLangSelect"),a=document.getElementById("gygHomepageLink");t&&new b(t);const n=()=>{const r=e[t.value]||e.en;a.href=r,a.textContent=r};t.addEventListener("change",n),n(),document.getElementById("gygHomepageCopyBtn")?.addEventListener("click",async()=>{const r=await g.copyToClipboard(a.href);p[r?"success":"error"](c.t(r?"deepLinkCopied":"copyError"))}),document.getElementById("gygHomepageOpenBtn")?.addEventListener("click",()=>{g.openLink(a.href)});const s=document.getElementById("gygInput"),i=document.getElementById("gygGenerateBtn"),o=document.getElementById("gygResult"),d=document.getElementById("gygResultLink");i.addEventListener("click",()=>{const r=s.value.trim();if(!r){p.warning(c.t("validGetYourGuideURL"));return}const m=g.generateGetYourGuideLink(r);m.success?(d.href=m.link,d.textContent=m.link,o.style.display="block",p.success(c.t("deepLinkGenerated"))):p.error(c.t(m.error))}),document.getElementById("gygCopyBtn")?.addEventListener("click",async()=>{const r=await g.copyToClipboard(d.href);p[r?"success":"error"](c.t(r?"deepLinkCopied":"copyError"))}),document.getElementById("gygOpenBtn")?.addEventListener("click",()=>{g.openLink(d.href)})}renderCivitatisPage(){return`
      <div class="page-header">
    ...
    `}initCivitatisPage(){const e={it:"https://www.civitatis.com/it/?aid=5488",es:"https://www.civitatis.com/es/?aid=5488",en:"https://www.civitatis.com/en/?aid=5488",fr:"https://www.civitatis.com/fr/?aid=5488"},t=document.getElementById("civLangSelect"),a=document.getElementById("civHomepageLink");t&&new b(t);const n=()=>{const r=e[t.value]||e.en;a.href=r,a.textContent=r};t.addEventListener("change",n),n(),document.getElementById("civHomepageCopyBtn")?.addEventListener("click",async()=>{const r=await g.copyToClipboard(a.href);p[r?"success":"error"](c.t(r?"deepLinkCopied":"copyError"))}),document.getElementById("civHomepageOpenBtn")?.addEventListener("click",()=>{g.openLink(a.href)});const s=document.getElementById("civInput"),i=document.getElementById("civGenerateBtn"),o=document.getElementById("civResult"),d=document.getElementById("civResultLink");i.addEventListener("click",()=>{const r=s.value.trim();if(!r){p.warning(c.t("validCivitatisURL"));return}const m=g.generateCivitatisLink(r);m.success?(d.href=m.link,d.textContent=m.link,o.style.display="block",p.success(c.t("deepLinkGenerated"))):p.error(c.t(m.error))}),document.getElementById("civCopyBtn")?.addEventListener("click",async()=>{const r=await g.copyToClipboard(d.href);p[r?"success":"error"](c.t(r?"deepLinkCopied":"copyError"))}),document.getElementById("civOpenBtn")?.addEventListener("click",()=>{g.openLink(d.href)})}renderCarRentalPage(){return`
      <div class="page-header">
    ...
    `}initCarRentalPage(){const e=document.getElementById("carProviderSelect"),t=document.getElementById("carLangSelect"),a=document.getElementById("carResultLink");e&&new b(e),t&&new b(t);const n=()=>{const s=B[e.value],i=t.value,o=s.urls[i]||s.urls.en||Object.values(s.urls)[0];a.href=o,a.textContent=o};e.addEventListener("change",n),t.addEventListener("change",n),n(),document.getElementById("carCopyBtn")?.addEventListener("click",async()=>{const s=await g.copyToClipboard(a.href);p[s?"success":"error"](c.t(s?"deepLinkCopied":"copyError"))}),document.getElementById("carOpenBtn")?.addEventListener("click",()=>{g.openLink(a.href)})}renderImageToolPage(){return`
      <div class="page-header">
