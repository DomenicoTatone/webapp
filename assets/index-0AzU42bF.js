(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();class y{constructor(e,t={}){this.originalSelect=e,this.options={searchable:t.searchable||!1,placeholder:t.placeholder||"Select...",...t},this.isOpen=!1,this.selectedIndex=-1,this.focusedIndex=-1,this.id=`custom-select-${Math.random().toString(36).substr(2,9)}`,this.init()}init(){this.originalSelect.style.display="none",this.originalSelect.setAttribute("aria-hidden","true"),this.container=this.createContainer(),this.originalSelect.parentNode.insertBefore(this.container,this.originalSelect.nextSibling),this.syncFromOriginal(),this.bindEvents()}createContainer(){const e=document.createElement("div");return e.className="custom-select",e.innerHTML=`
    ...
    `}initTradedoublerPage(){const e=document.getElementById("islandSelect"),t=document.getElementById("generateBtn"),a=document.getElementById("inputUrl"),n=document.getElementById("resultContainer"),i=document.getElementById("resultLink"),s=document.getElementById("programCardsContainer");e&&new y(e);const r=c=>{const o=B[c]||[];if(!c||o.length===0){s.innerHTML=`
          <div class="program-cards-empty">
            <span class="empty-icon">📋</span>
            <p data-i18n="selectSiteToViewPrograms">Seleziona un sito per vedere i programmi attivi</p>
          </div>
        `;return}const u=o.map(g=>{const h=m.getPartnerBaseLink(c,g),v=L[g]||"—",k=P[g]||"ALTRO";return`
      ...
      `,s.querySelectorAll("[data-copy]").forEach(g=>{g.addEventListener("click",async()=>{const h=g.dataset.copy;if(h){const v=await m.copyToClipboard(h);p[v?"success":"error"](d.t(v?"deepLinkCopied":"copyError"))}})})};e.addEventListener("change",()=>{const c=e.value;r(c),n.style.display="none"}),t.addEventListener("click",()=>{const c=e.value,o=a.value.trim();if(!c){p.warning(d.t("selectSite")||"Seleziona un sito");return}if(!o){p.warning(d.t("enterUrl"));return}const u=m.generateDeepLink(o,c);u.success?(i.href=u.link,i.textContent=u.link,n.style.display="block",p.success(`${d.t("deepLinkGenerated")} (${u.partner})`)):p.error(d.t(u.error)||u.error)}),document.getElementById("copyResultBtn")?.addEventListener("click",async()=>{const c=await m.copyToClipboard(i.href);p[c?"success":"error"](d.t(c?"deepLinkCopied":"copyError"))}),document.getElementById("openResultBtn")?.addEventListener("click",()=>{m.openLink(i.href)})}renderGetYourGuidePage(){return`
      <div class="page-header">
    ...
    `}initCivitatisPage(){const e={it:"https://www.civitatis.com/it/?aid=5488",es:"https://www.civitatis.com/es/?aid=5488",en:"https://www.civitatis.com/en/?aid=5488",fr:"https://www.civitatis.com/fr/?aid=5488"},t=document.getElementById("civLangSelect"),a=document.getElementById("civHomepageLink");t&&new y(t);const n=()=>{const o=e[t.value]||e.en;a.href=o,a.textContent=o};t.addEventListener("change",n),n(),document.getElementById("civHomepageCopyBtn")?.addEventListener("click",async()=>{const o=await m.copyToClipboard(a.href);p[o?"success":"error"](d.t(o?"deepLinkCopied":"copyError"))}),document.getElementById("civHomepageOpenBtn")?.addEventListener("click",()=>{m.openLink(a.href)});const i=document.getElementById("civInput"),s=document.getElementById("civGenerateBtn"),r=document.getElementById("civResult"),c=document.getElementById("civResultLink");s.addEventListener("click",()=>{const o=i.value.trim();if(!o){p.warning(d.t("validCivitatisURL"));return}const u=m.generateCivitatisLink(o);u.success?(c.href=u.link,c.textContent=u.link,r.style.display="block",p.success(d.t("deepLinkGenerated"))):p.error(d.t(u.error))}),document.getElementById("civCopyBtn")?.addEventListener("click",async()=>{const o=await m.copyToClipboard(c.href);p[o?"success":"error"](d.t(o?"deepLinkCopied":"copyError"))}),document.getElementById("civOpenBtn")?.addEventListener("click",()=>{m.openLink(c.href)})}renderCarRentalPage(){return`
      <div class="page-header">
    ...
    `}initCarRentalPage(){const e=document.getElementById("carProviderSelect"),t=document.getElementById("carLangSelect"),a=document.getElementById("carResultLink");e&&new y(e),t&&new y(t);const n=()=>{const i=S[e.value],s=t.value,r=i.urls[s]||i.urls.en||Object.values(i.urls)[0];a.href=r,a.textContent=r};e.addEventListener("change",n),t.addEventListener("change",n),n(),document.getElementById("carCopyBtn")?.addEventListener("click",async()=>{const i=await m.copyToClipboard(a.href);p[i?"success":"error"](d.t(i?"deepLinkCopied":"copyError"))}),document.getElementById("carOpenBtn")?.addEventListener("click",()=>{m.openLink(a.href)})}renderImageToolPage(){return`
      <div class="page-header">
    ...
    `}initImageToolPage(){const e=document.getElementById("dropZone"),t=document.getElementById("imageInput"),a=document.getElementById("qualitySlider"),n=document.getElementById("qualityValue"),i=document.getElementById("formatSelect"),s=document.getElementById("imagesContainer"),r=document.getElementById("downloadAllContainer");i&&new y(i),this.compressedImages=[],a.addEventListener("input",()=>{n.textContent=`${a.value}%`}),e.addEventListener("click",()=>t.click()),["dragenter","dragover","dragleave","drop"].forEach(c=>{e.addEventListener(c,o=>{o.preventDefault(),o.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",c=>{e.classList.remove("drag-over");const o=c.dataTransfer.files;this.processImages(o)}),t.addEventListener("change",()=>{this.processImages(t.files)}),document.getElementById("clearAllBtn")?.addEventListener("click",()=>{this.compressedImages=[],s.innerHTML="",r.style.display="none"}),document.getElementById("downloadAllBtn")?.addEventListener("click",async()=>{this.compressedImages.length!==0&&await this.downloadAllAsZip()})}async processImages(e){const t=document.getElementById("qualitySlider").value/100,a=document.getElementById("formatSelect").value,n=document.getElementById("imagesContainer"),i=document.getElementById("downloadAllContainer");for(const s of e)if(s.type.startsWith("image/"))try{const r=await this.compressImage(s,t,a);this.compressedImages.push(r),this.renderImageCard(r,n),this.updateTotalStats(),i.style.display="block"}catch(r){console.error("Compression error:",r),p.error(`Errore: ${s.name}`)}}compressImage(e,t,a){return new Promise((n,i)=>{const s=new FileReader;s.onload=r=>{const c=new Image;c.onload=()=>{const o=document.createElement("canvas");o.width=c.naturalWidth,o.height=c.naturalHeight,o.getContext("2d").drawImage(c,0,0),o.toBlob(g=>{if(!g){i(new Error("Compression failed"));return}const h=a==="image/webp"?"webp":a==="image/png"?"png":"jpg",v=e.name.replace(/\.[^/.]+$/,"");n({originalName:e.name,compressedName:`${v}_compressed.${h}`,originalSize:e.size,compressedSize:g.size,reduction:((1-g.size/e.size)*100).toFixed(1),blob:g,url:URL.createObjectURL(g)})},a,t)},c.onerror=i,c.src=r.target.result},s.onerror=i,s.readAsDataURL(e)})}renderImageCard(e,t){const a=document.createElement("div");a.className="image-card";const n=s=>s>1024*1024?`${(s/1024/1024).toFixed(2)} MB`:`${(s/1024).toFixed(1)} KB`,i=parseFloat(e.reduction)>50?"text-success":parseFloat(e.reduction)>20?"text-warning":"text-muted";a.innerHTML=`
    ...
    `,a.querySelector(".download-btn").addEventListener("click",()=>{const s=document.createElement("a");s.href=e.url,s.download=e.compressedName,s.click()}),a.querySelector(".remove-btn").addEventListener("click",()=>{const s=this.compressedImages.findIndex(r=>r.url===e.url);s>-1&&(URL.revokeObjectURL(e.url),this.compressedImages.splice(s,1),a.remove(),this.updateTotalStats(),this.compressedImages.length===0&&(document.getElementById("downloadAllContainer").style.display="none"))}),t.appendChild(a)}updateTotalStats(){const e=document.getElementById("totalStats");if(!e||this.compressedImages.length===0)return;const t=this.compressedImages.reduce((s,r)=>s+r.originalSize,0),a=this.compressedImages.reduce((s,r)=>s+r.compressedSize,0),n=((1-a/t)*100).toFixed(1),i=s=>s>1024*1024?`${(s/1024/1024).toFixed(2)} MB`:`${(s/1024).toFixed(1)} KB`;e.textContent=`${this.compressedImages.length} ${d.t("images")} • ${i(t)} → ${i(a)} (-${n}%)`}async downloadAllAsZip(){if(!window.JSZip){const n=document.createElement("script");n.src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js",document.head.appendChild(n),await new Promise(i=>n.onload=i)}const e=new JSZip;for(const n of this.compressedImages)e.file(n.compressedName,n.blob);const t=await e.generateAsync({type:"blob"}),a=document.createElement("a");a.href=URL.createObjectURL(t),a.download="compressed_images.zip",a.click(),URL.revokeObjectURL(a.href),p.success(d.t("downloadStarted"))}renderFeedbackPage(){return`
      <div class="page-header">
